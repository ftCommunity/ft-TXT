		...
		struct fb_videomode *panel)
{
	...
	printk(KERN_INFO "LCD:: %s: panel->sync = 0x%X FB_SYNC_CLK_INVERT = 0x%X panel->flag = 0x%X \n", __func__, panel->sync, FB_SYNC_CLK_INVERT, panel->flag);
	
	panel->sync = FB_SYNC_CLK_INVERT;
